...
public class MessageImportDialog extends MirthDialog {
    ...
    private void initComponents() {
        ...
        importServerRadio.setToolTipText(String.format("<html>Import messages from a file, folder or archive<br />on the %s Server.</html>", BrandingConstants.PRODUCT_NAME));
