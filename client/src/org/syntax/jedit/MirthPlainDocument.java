 ...
 */
public class MirthPlainDocument extends AbstractDocument {

	/**
	 * Name of the attribute that specifies the tab size for tabs contained in
	 * the content. The type for the value is Integer.
	 */
	public static final String tabSizeAttribute = "tabSize";

	/**
	 * Name of the attribute that specifies the maximum length of a line, if
	 * there is a maximum length. The type for the value is Integer.
	 */
	 ...
	 * happen within a write lock. Since this document simply maps out lines, we
	 ...
	 * happen within a write lock. Since the structure represents a line map,
	 * this just checks to see if the removal spans lines. If it does, the two
	...
	private boolean isComposedTextElement(Element elem) {
